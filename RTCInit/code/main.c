...
int main(void)
{
    ...
    while (1)
    {
        ...
        //     *pbufLcd++ = time.weekdays + '0';
        //     *pbufLcd++ = '.';

        //     *pbufLcd++ = time.months + '0';
        //     *pbufLcd++ = '.';

        //     *pbufLcd++ = time.years + '0';
        //     *pbufLcd++ = '.';

        //     *pbufLcd++ = (time.days >> 4) + '0';
        //     *pbufLcd++ = (time.days & 0x0F) + '0';
        //     *pbufLcd++ = ' ';

        //     *pbufLcd++ = (time.hours >> 4) + '0';
        //     *pbufLcd++ = (time.hours & 0x0F) + '0';
        //     *pbufLcd++ = ':';
